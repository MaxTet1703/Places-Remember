...
GOOD_DATA_FOR_FORM = [
    ...
    },
    {
        ...
        "description": """Это отлично, что в городе не
        только появляются новые спортивные объекты, но и реконструируются уже существующие. 
...
BAD_DATA_FOR_FORM = [
    ...
    },
    {
        ...
        "description": """Окончил специалитет, аспирантуру и стал кандидатом наук! 
        Всем желаю сделать правильный выбор""",
        "longitude": 54.0,
        "latitude": 200.0
    }
]
